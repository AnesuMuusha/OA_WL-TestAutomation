...
test("OA/signupaddpreschoolChild", async () => {
  ...
  try {
    ...
    //     smsPage.screenshot({ path: path.join(SCREENSHOTS_DIR, "turnstile-fail.png") });
    //   });
    // } else {
    ...
    //   await smsPage.screenshot({ path: path.join(SCREENSHOTS_DIR, "no-otp-found.png") });
    // }
